...
| 遊戲 | **Pikmin Bloom 149.0**，versionCode **1784082813** |
| 安裝檔 | [`dist/pikmin-gps-copy-v149-r9.zip`](dist/pikmin-gps-copy-v149-r9.zip) |
...
1. 下載 [`pikmin-gps-copy-v149-r9.zip`](dist/pikmin-gps-copy-v149-r9.zip)。
2. 可選：比對檔案 SHA-256：

   ```text
   155E137BE73A104083C00B1AE5445578386A3EEE4724A730C9287D6FB1813110
   ```
...
- Magisk 安裝包：`dist\pikmin-gps-copy-v149-r9.zip`
...
| Game | **Pikmin Bloom 149.0**, versionCode **1784082813** |
| Package | [`dist/pikmin-gps-copy-v149-r9.zip`](dist/pikmin-gps-copy-v149-r9.zip) |
...
1. Download [`pikmin-gps-copy-v149-r9.zip`](dist/pikmin-gps-copy-v149-r9.zip).
...
- Magisk package: `dist\pikmin-gps-copy-v149-r9.zip`
