...
| 遊戲 | **Pikmin Bloom 152.0**，versionCode **1787540739** |
| 安裝檔 | [`dist/pikmin-gps-copy-v152-r12.zip`](dist/pikmin-gps-copy-v152-r12.zip) |
...
1. 下載 [`pikmin-gps-copy-v152-r12.zip`](dist/pikmin-gps-copy-v152-r12.zip)。
2. 可選：比對檔案 SHA-256：

   ```text
   71A1FC516CFCB0671BEC1216E5C9FC743FF06B2B09FD2332A7D86EC5F5A25D67
   ```
...
- Magisk 安裝包：`dist\pikmin-gps-copy-v152-r12.zip`
...
| Game | **Pikmin Bloom 152.0**, versionCode **1787540739** |
| Package | [`dist/pikmin-gps-copy-v152-r12.zip`](dist/pikmin-gps-copy-v152-r12.zip) |
...
1. Download [`pikmin-gps-copy-v152-r12.zip`](dist/pikmin-gps-copy-v152-r12.zip).
...
- Magisk package: `dist\pikmin-gps-copy-v152-r12.zip`
